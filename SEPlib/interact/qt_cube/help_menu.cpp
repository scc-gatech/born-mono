...
help_menu::help_menu(datasets * dats, QString num,int nd)
{
  this->set_basics(dats,num,"Help",nd);

	ModesWidget=new QTextEdit(this,"Modes"); edits.push_back(ModesWidget);
	MouseWidget=new QTextEdit(this,"Mouse"); edits.push_back(MouseWidget);
	
	LoadWidget=new QTextEdit(this, "Load"); edits.push_back(LoadWidget);

	CommandWidget=new QTextEdit(this,"CommandLine");edits.push_back(CommandWidget);

	KeysWidget=new QTextEdit(this,"Keyboard");edits.push_back(KeysWidget);

	HistWidget=new QTextEdit(this,"History"); edits.push_back(HistWidget);
	ClipWidget=new QTextEdit(this,"Cliping"); edits.push_back(ClipWidget);

}
void help_menu::createit() {
