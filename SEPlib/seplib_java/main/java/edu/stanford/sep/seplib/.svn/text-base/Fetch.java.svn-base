...
public class Fetch {
     ...
     */
    public static native int fetch(String name, String format, int[] val);
    /**
     ...
     * @return       The number of values returned.
     */
    public static native int fetch(String name, String format, float[] val);
    /**
     ...
     * @return       The number of values returned.
     */
    public static native int fetch(String name, String format, double[] val);
    /**
     ...
     * @return       The number of values returned.
     *
     * Note: this is private because fetch doesn't know about bytes.
     */
    private static native int fetch(String name, String format, byte[] val);
    /**
     ...
     */
    public static int fetch(String name, String format, StringBuffer val) {
       int rc = 0;
       byte byteBuf[] = new byte[2048];
       rc = fetch(name, format, byteBuf);
       if(rc > 0) {
