...
public class Hetch {
     ...
     */
    public static native int hetch(String name, String format, int[] val);
    /**
     ...
     * @return       The number of values returned.
     */
    public static native int hetch(String name, String format, float[] val);
    /**
     ...
     * @return       The number of values returned.
     */
    public static native int hetch(String name, String format, double[] val);
    /**
     ...
     * @return       The number of values returned.
     *
     * Note: this is private because hetch doesn't know about bytes.
     */
    private static native int hetch(String name, String format, byte[] val);
    /**
     ...
     */
    public static int hetch(String name, String format, StringBuffer val) {
       int rc = 0;
       byte byteBuf[] = new byte[2048];
       rc = hetch(name, format, byteBuf);
       if(rc > 0) {
