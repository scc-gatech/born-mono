...
#include <jni.h>
/* Header for class edu_stanford_sep_seplib_corelibs_sep_Tetch */

#ifndef _Included_edu_stanford_sep_seplib_corelibs_sep_Tetch
#define _Included_edu_stanford_sep_seplib_corelibs_sep_Tetch
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     edu_stanford_sep_seplib_corelibs_sep_Tetch
 * Method:    tetch
