...
!
! USAGE
! call icai3(adj,add,lag1,lag2,lag3,xx,n1,n2,n3,aa,na1,na2,na3,yy)
!
! INPUT PARAMETERS
...
!
! DESCRIPTION
! Internal Convolution, Adjoint is the Input.  3-dimensional
!
! CATEGORY
! Lib:Filter
!
...
!>
!
subroutine icai3( adj,add, lag1,lag2,lag3, aa,na1,na2,na3,  xx,n1,n2,n3&
  &, yy)
use sep_mod
integer           adj,add, lag1,lag2,lag3,    na1,na2,na3,     n1,n2&
  &,n3
real                                       aa(na1,na2,na3), xx(n1,n2,n3&
  &)
real                                                        yy(n1,n2,n3&
  &)
integer                                      a1,a2,a3,   x1,x2,x3,   &
  & y1,y2,y3
...
call adjnull(    adj, add,                           xx,n1*n2*n3,   yy&
  &,n1*n2*n3)
do a3=1,na3  
      ...
      do y2= 1+na2-lag2, n2-lag2+1  
        ...
        do a1=1,na1  
          do y1= 1+na1-lag1, n1-lag1+1  
            x1= y1 - a1 + lag1
            if ( adj .eq. 0 ) then
              yy( y1,y2,y3) = yy( y1,y2,y3) + xx( x1,x2,x3) * aa( a1,a2&
                &,a3)
            else
              xx( x1,x2,x3) = xx( x1,x2,x3) + yy( y1,y2,y3) * aa( a1,a2&
                &,a3)
            end if
          end do
        end do
