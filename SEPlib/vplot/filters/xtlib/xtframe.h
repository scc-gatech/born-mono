#ifndef VP_XT_FRAME_H
#define VP_XT_FRAME_H
...
extern xtFrame* xt_frame( xtFrameList*, int, long );
extern void xt_add_frame( xtFrameList *, xtFrame * );
extern xtFrame* xt_new_frame(int,long);
...
extern void xt_store_image( xtFrame* );
extern void xt_put_image( xtFrame* );
extern void xt_clear_images( xtFrameList* );    
extern xtFrame* xt_find_frame(xtFrameList *,int,long);
extern void xt_restore_colormap(xtFrame *);
