...
/*ARGSUSED7*/
void
genraster (int count, int out_of, int xpos, int ypos, int length, int orient, unsigned short *raster, int dummy1, int dummy2, int byte2)
{
...
/*   if(byte2==1)*/
/*   ERR(FATAL,"Asked for two byte option with generaster (unimplemented) \n");*/
