...
class float_mmap_buffer: public buffer{
  public:
    ...
    float_mmap_buffer(std::shared_ptr<SEP::paramObj>p, std::shared_ptr<SEP::hypercube>h,std::shared_ptr<SEP::io_func>i,int in,std::vector<int>&nw, std::vector<int>&fw);
