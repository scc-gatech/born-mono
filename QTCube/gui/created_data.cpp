...
#include <iostream>
using namespace SEP;
created_data_float::created_data_float(std::string title,QString nm,std::shared_ptr<hypercube>g,std::shared_ptr<io_func>i, std::shared_ptr<paramObj>p, int in,int im){
...
std::shared_ptr<buffer>created_data_float::create_buffer(std::shared_ptr<orient_cube>pos, int iax1, int iax2){
...
created_data_byte::created_data_byte(std::string title,QString nm, std::shared_ptr<hypercube>g,std::shared_ptr<io_func>i, std::shared_ptr<paramObj>p, int in,int im){
  set_basics(title,nm,g,i,p,in,im);

}
std::shared_ptr<buffer>created_data_byte::create_buffer(std::shared_ptr<orient_cube>pos, int iax1, int iax2){
